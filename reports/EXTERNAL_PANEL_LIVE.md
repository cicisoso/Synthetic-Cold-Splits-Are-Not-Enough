...
| Benchmark | Seeds | Base AUPRC / AUROC | DTI-LM AUPRC / AUROC | HyperPCM AUPRC / AUROC | Winner |
|-----------|-------|--------------------|----------------------|-------------------------|--------|
| `BindingDB_Ki / unseen_target` | 3/3 | `0.6934 ± 0.0257 / 0.7192 ± 0.0068` | `0.6648 ± 0.0177 / 0.6936 ± 0.0044` | `0.6515 ± 0.0301 / 0.6757 ± 0.0211` | `base` |
| `DAVIS / unseen_target` | 3/3 | `0.4097 ± 0.0275 / 0.8613 ± 0.0153` | `0.4090 ± 0.0570 / 0.8718 ± 0.0152` | `0.3840 ± 0.0269 / 0.8610 ± 0.0245` | `base` |

## Graph-Family Probe

The promoted graph-family probe does not overturn the main panel on any completed axis, but it is competitive enough to rule out the objection that the expanded panel contains only fixed-vector and pooled-LM systems.
