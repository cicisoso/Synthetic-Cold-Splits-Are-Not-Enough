\begin{table}[t]
  \centering
  \scriptsize
  \caption{Explicit specification of the promoted patent benchmarks. The temporal partition is fixed by year; the random seed changes model stochasticity, not the partition itself.}
